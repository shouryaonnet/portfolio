      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center w-full">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto mt-2">
            ...
            <a
              href="#projects"
              className="px-4 py-2.5 rounded-lg bg-[#0b0f19] hover:bg-slate-800 text-white text-[13px] font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-sm group"
            >
            ...
            <a
              href="/resume.pdf"
              download
              className="px-4 py-2.5 rounded-lg bg-white hover:bg-slate-50 text-slate-700 text-[13px] font-medium border border-slate-200 transition-all duration-200 flex items-center justify-center gap-2"
            >
              <Download
                size={15}
                strokeWidth={1.8}
            ...
            <a
              ...
              className="px-4 py-2.5 rounded-lg bg-[#f8fafc] hover:bg-slate-100 text-slate-700 text-[13px] font-medium border border-slate-200/80 transition-all duration-200 flex items-center justify-center gap-2"
            >
              <Eye
                size={15}
                strokeWidth={1.8}
            ...
            <div className="flex flex-wrap gap-2">
              {techStack.map((item) => {
                ...
                return (
                  <div
                    key={item.name}
                    className="px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-xs font-medium text-slate-700 flex items-center gap-2 hover:border-slate-300 hover:text-slate-900 hover:bg-slate-50 transition-all cursor-default"
                  >
